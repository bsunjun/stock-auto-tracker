# PR #62 Acceptance Criteria

This document lists the acceptance criteria that PR #62 must satisfy
before it is merged.
...
- [ ] All seven new files reside under the
      `read_only_observation_start_gate/` directory and nowhere
      else.
- [ ] No file outside `read_only_observation_start_gate/` is
      created or modified.

## Non-Modification Criteria

- [ ] No file from PR #50 – PR #61 is modified.
...
- [ ] No real approval record is committed. The repo holds policy
      and templates only.
...
- [ ] The required approval wording appears verbatim as the
      prescribed required wording in the README and in
      `START_GATE_APPROVAL_RECORD_POLICY.md`. It is not asserted as
      an actual approval anywhere.
...
established in PR #50 – PR #61 must not appear in any added file
...
documents established in PR #50 – PR #61.
...
- [ ] The merge of PR #62 alone does **not** start automated
