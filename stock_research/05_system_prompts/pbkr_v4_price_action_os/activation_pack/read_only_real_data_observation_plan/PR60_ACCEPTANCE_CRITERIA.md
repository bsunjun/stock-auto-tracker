# PR #60 Acceptance Criteria

This document lists the acceptance criteria that PR #60 must satisfy
before it is merged.

## Structural Criteria

- [ ] Exactly eight new markdown files are added under
      `stock_research/05_system_prompts/pbkr_v4_price_action_os/activation_pack/read_only_real_data_observation_plan/`.
- [ ] All eight new files have the `.md` extension.
- [ ] All eight new files reside under the
      `read_only_real_data_observation_plan/` directory and nowhere
      else.
- [ ] No file outside `read_only_real_data_observation_plan/` is
      created or modified.

## Non-Modification Criteria

- [ ] No file from PR #50 – PR #59 is modified.
...
established in PR #50 – PR #59 must not appear in any added file
...
- [ ] The merge of PR #60 alone does **not** start real-data
      observation.

## Self-Verification Summary (To Be Confirmed at Merge Time)

- Added files count: 8
- Modified files count: 0 (excluding the 8 new files)
